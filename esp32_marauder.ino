...
#ifdef HAS_BUTTONS_Div
 
 /*

 // Creazione bottoni virtuali
Switches u_btn(readUBtn, 1000);
Switches d_btn(readDBtn, 1000);
Switches l_btn(readLBtn, 1000);
Switches r_btn(readRBtn, 1000);
Switches c_btn(readCBtn, 3000);

Switches u_btn(U_BTN, 1000, U_PULL);
Switches d_btn(D_BTN, 1000, D_PULL);
Switches l_btn(L_BTN, 1000, L_PULL);
Switches r_btn(R_BTN, 1000, R_PULL);
Switches c_btn(C_BTN, 3000, C_PULL);
